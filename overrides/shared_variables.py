...
def init():
    global HOSTS_CONFIG, GROUPS_CONFIG, PROFILE_CONFIG, SELECTIONS, CHANGES_PENDING, list_of_method_names, method_to_module_map, list_of_method_subfolders, list_of_profiles_subfolders, list_of_profile_names, profiles_properties
